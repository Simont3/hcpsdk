...
if __name__ == '__main__':
    ...
    try:
        ...
        print('GET status:', conns._response.status, flush=True, file=sys.stderr)
    except Exception as exc:
    ...
    try:
        ...
        print('DELETE status:', conns._response.status, flush=True, file=sys.stderr)
    except Exception as exc:
